...
const SideContact = () => {
  ...
  return (
    <aside className="hidden lg:flex fixed right-4 top-1/2 -translate-y-1/2 z-40 flex-col items-center gap-2 bg-card border rounded-xl shadow-card p-3 w-40">
      ...
      <div className="h-14 w-14 rounded-full bg-gradient-blue flex items-center justify-center text-primary-foreground">
      ...
      <div className="w-full pt-2 border-t space-y-1.5">
        <a href="#" className="block text-xs text-center text-primary hover:underline">官方导航</a>
        <a href="#" className="block text-xs text-center text-primary hover:underline">彩票论坛</a>
        <a href="#" className="block text-xs text-center text-primary hover:underline">注册 / 登录</a>
      </div>
